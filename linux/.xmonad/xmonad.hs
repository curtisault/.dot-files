...
myTerminal      = "bash"     -- Sets default terminal
myTextEditor    = "vim"     -- Sets default text editor
myBorderWidth   = 2         -- Sets border width for windows
windowCount     = gets $ Just . show . length . W.integrate' . W.stack . W.workspace . W.current . windowset

main = do
    xmproc0 <- spawnPipe "xmobar -x 0 /home/ca/.config/xmobar/xmobarrc2" -- xmobar mon 2
    xmproc1 <- spawnPipe "xmobar -x 1 /home/ca/.config/xmobar/xmobarrc1" -- xmobar mon 1
    xmproc2 <- spawnPipe "xmobar -x 2 /home/ca/.config/xmobar/xmobarrc0" -- xmobar mon 0
...
myStartupHook = do
          ...
          spawnOnce "compton --config /home/ca/.config/compton/compton.conf &" 
          setWMName "LG3D"
